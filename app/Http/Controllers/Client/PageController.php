...
class PageController extends Controller
{
    ...
    public function aboutUs(){
        ...
        $data['aboutUs'] = PageContent::where(['language'=>'vi', 'status'=>1 , 'type'=>'ve-chung-toi'])->first(['id','title','content']);
    ...
    {
        $data['list'] = Prize::where(['status'=>1])->paginate(12);
        return view('video',$data);
    }
    public function yeuCauTuVan()
    {
        $data['list'] = Product::where(['status'=>1])->orderBy('id','DESC')->limit(12)->get();
        return view('yeucautuvan',$data);
    }
}

...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    Route::get('video.html','PageController@listVideo')->name('listVideo');
    ...
    Route::get('cong-trinh-du-an','PageController@listDuan')->name('listDuan');
    ...
    Route::get('yeu-cau-tu-van.html','PageController@yeuCauTuVan')->name('yeuCauTuVan');
